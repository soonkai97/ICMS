  ...
  <body class="size-1140">
    ...
    <main role="main">
      ...
      <section class="section background-dark">
      	<p align="middle";><font size="+3"><b>Event Form</b></font></p><br>
      	<form action="/ICMS/BUSS_LAYER/EventController/EventController.php" method="POST">
      		<table border="0" align="center">

				      <div class="col-sm-6" align="center"><label>Event ID:&nbsp</label><input name='EventID'>
            ...
            <option value="Library">Mini Theatre</option>
					  ...
					  <div class="row">
						...
						<input type="text" hidden value="insert" name="method">
						<input type="submit" name="insert()" class="btn btn-success"  value="Submit">
						<input type="button" class="btn btn-success" onclick="window.location.replace('committee.php')" value="Cancel" />
