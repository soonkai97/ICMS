...
include ('/xampp/htdocs/ICMS/BUSS_LAYER/EventController/EventController.php');
?>
<!doctype html>
<html lang="en-US">
  <head>
  ...
  <body class="size-1140">
    ...
    <main role="main">
      ...
      <section class="section background-dark">
        <p align="middle";><font size="+3"><b>Participants</b></font></p><br>
        <table border="0" align="center">
         ...
         <br><center><input type="button" class="btn btn-success" onclick="window.location.replace('EventList.php')" value="Back" /></center>
      </section>
    </main>
