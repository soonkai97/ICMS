  ...
  <body class="size-1140">
    ...
    <main role="main">
      ...
      <section class="section background-dark">
      	<p align="middle";><font size="+3"><b>Jury List</b></font></p><br>
		...
		<?php 
    		while($row = $alljury->fetch_assoc()){
    			echo '<tr>';
    			echo '<td align="center">'.$row['Jury_ID'].'</td>';
    			echo '<td align="center">'.$row['Name'].'</td>';
    			echo '<td align="center">'.$row['Email'].'</td>';
				echo '<td align="center">'.$row['Category'].'</td>';

    		
				echo '<td><a href=/ICMS/BUSS_LAYER/EvaluationController/EvaluationController.php?dlt_id='.$row['Jury_ID'].'" onclick="return confirm(\'Really delete?\');";>Delete</a></td>';
    			echo '</tr>';
    		}
    		?>
