  ...
  <body class="size-1140">
    ...
    <main role="main">
      ...
      <section class="section background-dark">
      	<p align="middle";><font size="+3"><b>Event List</b></font></p><br>
		...
		<?php 
          ...
          echo '<td align="center">'.$row['Categories'].'</td>';
    			echo '<td align="center">'.$row['EventLocation'].'</td>';
    			echo '<td align="center">'.$row['EventDate'].'</td>';
				echo '<td align="center">'.$row['EventTime'].'</td>';

        echo '<td><a href=/ICMS/BUSS_LAYER/EventController/EventController.php?delete='.$row['EventID'].'" onclick="return confirm(\'Confirm delete?\');";>Delete</a></td>';

        echo'<td><a href=/ICMS/Example/Committee_View/UpdateForm.php onclick="return confirm(\'Confirm update?\');";>Update</a></td>';

       // echo '<td><a href=/ICMS/BUSS_LAYER/EventController/EventController.php?list='.$row['EventID'].'" onclick="return confirm(\'Confirm view?\');";>Participants</a></td>';
        

                echo'<td><a href=/ICMS/Example/Committee_View/ParticipantList.php onclick="return confirm(\'Confirm view?\');";>Participants</a></td>';
    		...
    		?>
                ...
                <input align="center" type="button" class="btn btn-success" onclick="window.location.replace('EventForm.php')" value="Add Event" />
